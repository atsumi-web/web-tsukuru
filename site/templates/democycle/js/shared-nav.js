...
// Since it's inside `democycle/hp/`, we assume root relative paths if deployed statically.
  ...
  const html = `
    <header class="l-header ${headerTheme}" id="js-header">
      <a href="${rp}index.html" class="l-header-logo">
        <img src="${rp}images/logo-mark.webp" alt="Urban Mobility Logo" class="logo-img">
        <span class="logo-text">URBAN<span style="color:var(--gold);">.</span>MOBILITY</span>
      </a>
        ...
        <div class="l-footer-inner">
          ...
          <div class="f-col">
            <div style="display:flex; align-items:center; gap:12px; margin-bottom:24px;">
              <img src="${rp}images/logo-mark.webp" alt="Urban Mobility Logo" class="f-logo-img">
              <p class="f-company-name" style="margin-bottom:0;">株式会社アーバンモビリティ</p>
            </div>
            <p class="f-address">
              東京本社 東京都港区ダミー町1-1-1<br><br>
              目黒オフィス 東京都目黒区ダミー町2-2-2<br><br>
          ...
          <div class="f-col">
            <div class="f-sns">
              ...
              <a href="#" target="_blank" class="f-sns-link" aria-label="LINE"><i class="fa-brands fa-line"></i></a>
              <a href="#" target="_blank" class="f-sns-link" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
              <a href="#" target="_blank" class="f-sns-link" aria-label="YouTube"><i class="fa-brands fa-youtube"></i></a>
            </div>
          </div>
        </div>
        
        <p class="f-bottom">Urban Mobility Inc. All Rights Reserved.</p>
      </div>
